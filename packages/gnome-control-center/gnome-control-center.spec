...
%global pronk_base 0e0b484e2999519886a9885dc2f8514a8280a84e
%global gvc_commit d2442f455844e5292cb4a74ffc66ecc8d7595a9f
%global libgxdp_commit df896e3412b749947bc6f62a91a1aac8e6b6d19b
...
Source2:        https://gitlab.gnome.org/GNOME/libgxdp/-/archive/%{libgxdp_commit}/libgxdp-%{libgxdp_commit}.tar.gz

Patch0100:      0001-casting-Add-casting-service-D-Bus-contract.patch
Patch0101:      0002-casting-Define-Pronk-protocol-values.patch
Patch0102:      0003-casting-Validate-Pronk-protocol-payloads.patch
Patch0103:      0004-casting-Represent-casting-device-state.patch
Patch0104:      0005-casting-Reconcile-casting-device-inventory.patch
Patch0105:      0006-casting-Track-Pronk-setup-operations.patch
Patch0106:      0007-casting-Track-Pronk-display-sessions.patch
Patch0107:      0008-casting-Add-Pronk-service-client.patch
Patch0108:      0009-casting-Add-casting-device-row.patch
Patch0109:      0010-casting-Add-Casting-panel-interface.patch
Patch0110:      0011-build-Integrate-Casting-panel.patch
Patch0111:      0012-shell-Register-Casting-panel.patch
Patch0112:      0013-shell-Place-Casting-with-connectivity-panels.patch
Patch0113:      0014-i18n-Extract-Casting-panel-messages.patch
...
tar -xzf %{SOURCE1} --strip-components=1 -C subprojects/gvc
mkdir -p subprojects/libgxdp
tar -xzf %{SOURCE2} --strip-components=1 -C subprojects/libgxdp
