...
%global pronk_base fd610b86a526a504a217c5532c47865273c95b10
Source0: https://gitlab.gnome.org/GNOME/gnome-desktop/-/archive/%{pronk_base}/gnome-desktop-%{pronk_base}.tar.bz2
%global qrcodegen_base 8329a7108fc22be3e1eec0a9f9318978579e3621
Source1: https://github.com/nayuki/QR-Code-generator/archive/%{qrcodegen_base}/qrcodegen-%{qrcodegen_base}.tar.gz
...
%prep
%autosetup -n gnome-desktop-%{pronk_base}
tar -xf %{SOURCE1} -C subprojects
mv subprojects/qrcodegen-%{qrcodegen_base} subprojects/qrcodegen
cp -a subprojects/packagefiles/qrcodegen/. subprojects/qrcodegen
...
- Build GNOME desktop 51 for the GNOME 51 stack
